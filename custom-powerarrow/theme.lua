...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/custom-powerarrow"
theme.wallpaper                                 = theme.dir .. "/forest.jpg"
...
local mytextclock = wibox.widget.textclock(markup("#000000", "%A %d %B ") .. markup("#ffffff", ">") .. markup("#ffffff", " %H:%M "))
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
	    ...
	    --wibox.container.background(wibox.container.margin(wibox.widget {, theme.fs and theme.fs.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#CB755B"),
            arrow("#CB755B", "#8DAA9A"),
	    ...
	    arrow("#777E76", "#777E76"),
	    wibox.container.background(wibox.container.margin(wibox.widget { nil, mytextclock, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#777E76"),
            arrow("#777E76", "alpha"),
            --]]
            s.mylayoutbox,
        },
