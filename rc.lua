...
--beautiful.init(gears.filesystem.get_themes_dir() .. "byte/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "main", "www", "teams", "graphics", "5", "6", "7", "8", "9" }
    local l = awful.layout.suit
    local layouts = {l.floating, l.tile, l.max, l.tile, l.floating, l.floating,
		     l.floating, l.floating, l.floating}
